...
if(NOT "/home/jared/csws/src/async_web_server_cpp/include;/usr/include " STREQUAL " ")
  set(async_web_server_cpp_INCLUDE_DIRS "")
  set(_include_dirs "/home/jared/csws/src/async_web_server_cpp/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'async_web_server_cpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jared/csws/src/async_web_server_cpp/${idir}'.  ${_report}")
    endif()
